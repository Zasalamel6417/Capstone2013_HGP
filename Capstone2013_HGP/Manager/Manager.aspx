<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manager.aspx.cs" Inherits="Capstone2013_HGP.Manager.Manager" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <br />
    <asp:GridView ID="gvReservation" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="gvReserve" OnPageIndexChanged="gvReservation_PageIndexChanged" OnRowCommand="gvReservation_RowCommand" DataKeyNames="eventID">
        <Columns>
