<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FAQ.aspx.cs" Inherits="Capstone2013_HGP.FAQ" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="headertwo2">
        <h2><i>How Do I Cancel a purchased ticket?</i></h2>
    </div>
    <div id="faqContents1">
        <ol>
